///scr_draw_lensflare(x,y,Radius,SizeX,SizeY,RingSize,Transparency,GlowOpacity)
...
/*        draw_sprite_ext(Siris,1,-xx+(center_x*2),-yy+(center_y*2),Size_x * point_distance(xx,yy,center_x,center_y)/((center_x*2)*.5), Size_y *point_distance(xx,yy,center_x,center_y)/((center_x*2)*.5),direction,draw_get_colour(),alpha)
        ...
        */
        //The ring
        if(alpha>0){
            draw_sprite_ext(Sring,0,center_x,center_y,RingSize *point_distance(center_x,center_y,xx,yy)/(view_wview/2),RingSize *point_distance(center_x,center_y,xx,yy)/(view_wview/2) ,LensDir,-1,alpha/2)
        }
